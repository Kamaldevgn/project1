...
const SocialLink = ({ href, children }) => (
  <a 
    ...
    className="p-[0.3rem] hover:bg-white rounded-md hover:text-black transition-colors duration-400"
  >
    {children}
  </a>
);
    ...
    <div className="my-5 flex items-center justify-between">
      ...
      <div className="mb-5 flex gap-3 items-center text-m">
        ...
        <div className="flex gap-1 items-center">
          <SocialLink href="https://www.linkedin.com/in/kamalpreet-singh-a54351322/">
            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor">
          ...
          <SocialLink href="https://github.com/Kamaldevgn">
            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor">
